...
class PlayIndicatorWidget(BoxLayout):
    ...
    image_source_on = "images/indicator_light_on.png"
    image_source_off = "images/indicator_light_off.png"
    ...
    def set_current_step_index(self, index):
        ...
        for i in range(0, len(self.lights)):
            light = self.lights[i]
            if i == index:
                light.source = self.image_source_on
            else:
                light.source = self.image_source_off
